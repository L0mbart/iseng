...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'namespace' => 'Admin', 'middleware' => ['auth']], function () {
    ...
    // Updatetickets
    Route::delete('update-tickets/destroy', 'UpdateTicketController@massDestroy')->name('update-tickets.massDestroy');
    Route::resource('update-tickets', 'UpdateTicketController');

    // Createtickets
    Route::delete('create-tickets/destroy', 'CreateTicketController@massDestroy')->name('create-tickets.massDestroy');
    Route::resource('create-tickets', 'CreateTicketController');

    // Closetickets
    Route::delete('close-tickets/destroy', 'CloseTicketController@massDestroy')->name('close-tickets.massDestroy');
    Route::resource('close-tickets', 'CloseTicketController');
